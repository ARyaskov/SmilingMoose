...
public final class Scene extends JPanel {
    ...
    public Scene(BBJ bbj) {
        ...
        m_messageSelector_y = m_app.m_messageSelector.getY();
        m_entitySelector_x = m_app.m_entitySelector.getX();
        m_entitySelector_y = m_app.m_entitySelector.getY() + 110;
    ...
    protected void paintComponent(Graphics g) {
        ...
        g.fillRect(0,
                m_entitySelector_y+m_entitySelector_height-2,
                m_scene_width,
                m_scene_height);
        // Красим между
         g.fillRect(0,
                m_messageSelector_y+m_messageSelector_height+10,
                m_scene_width,
                10);
